...
EXPERIMENT_NAME = "hierarchical_bilstm_crf_v2"
...
model = HierarchicalBiLSTMCRF(len(vocab), len(label_encoder.classes_), class_weights).to(DEVICE)
...
for epoch in range(EPOCHS):
    ...
    for step, (X, y, mask) in enumerate(tqdm(train_loader)):
